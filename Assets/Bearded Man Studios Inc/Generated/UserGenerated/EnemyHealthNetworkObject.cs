...
namespace BeardedManStudios.Forge.Networking.Generated
{
	...
	public partial class EnemyHealthNetworkObject : NetworkObject
	{
		...
		public EnemyHealthNetworkObject() : base() { Initialize(); }
		public EnemyHealthNetworkObject(NetWorker networker, INetworkBehavior networkBehavior = null, int createCode = 0, byte[] metadata = null) : base(networker, networkBehavior, createCode, metadata) { Initialize(); }
		public EnemyHealthNetworkObject(NetWorker networker, uint serverId, FrameStream frame) : base(networker, serverId, frame) { Initialize(); }
